...
class FormAddC extends Component {
  state = {
    societe: "",
    nom: "",
    prenom: "",
  ...
  render() {
    return (
      <div className="overlay">
        <Wrapper>
          <h2>Ajouter un client dans la base</h2>
...
const mapDispatchToProps = dispatch => {
  return {
    addClient: (societe, nom, prenom, fonction, telephone, mobile, email) => {
      dispatch({
        type: "ADD_CLIENT",
        id: Date.now() - 999999999999,
        societe,
        nom,
        prenom,
        fonction,
