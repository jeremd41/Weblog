...
class TempCdeC extends Component {
  state = {
    ...
    client: this.props.commande.client,
  ...
  handleDelete = event => {
    ...
    this.props.deleteCdeC(this.state.nCde);
    this.props.history.push("/cdeclient");
  };
...
const mapDispatchToProps = dispatch => {
  return {
    updateCdeC: (nCde, client, reference, dateCde, dateLiv, observation) => {
      dispatch({
        type: "UPDATE_CDEC",
        nCde,
        client,
    ...
    deleteCdeC: nCde => {
      dispatch({ type: "DELETE_CDEC", nCde: nCde });
    }
  };
};
